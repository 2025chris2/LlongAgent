...
class LoveAppTest {
    ...
    void doChat() {
        ...
        // 第一轮
        String message="你好，我是程序员唐";
        String answer = loveApp.doChat(message, chatId);
        // 第二轮
//        message="我想让另一半(KD)更爱我";
...
//        Assertions.assertNotNull(answer);
    ...
    void doChatWithReport() {
        String chatId = UUID.randomUUID().toString();
        // 一轮
        String userMessage = "你好，我是程序员鱼皮，我想让另一半（编程导航）更爱我，但我不知道该怎么做";
    ...
    private void testMessage(String message) {
        String chatId =UUID.randomUUID().toString();
        String answer = loveApp.chatWithTools(message, chatId);
        Assertions.assertNotNull(answer);
